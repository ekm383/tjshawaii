...
const IndexPage = () => {
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "closure.jpg" }) {
        childImageSharp {
    ...
    <Layout>
      ...
      <HeaderIndex>
        <Section style={{ width: "100vw", alignItems: "center" }}>
          <Banner subtitle="TJ's Sports Bar is located on the corner of Kapiolani and South Street in Honolulu, Hawaii. We're an upbeat sports bar with  billiard tables, darts, a jukebox, and eclectic pub grub menu."></Banner>
        </Section>
      </HeaderIndex>
      <Gallery />
      <Section style={{ margin: "2rem auto" }}>
        <Img
          style={{ width: "500px", margin: "0rem auto" }}
      ...
      <Section style={{ margin: "2rem auto" }}>
        ...
        >
          ...
          <p>
            Choice of either white rice, brown rice. Option to replace rice with
            Quinoa - $2. Choice of either tossed or mac salad
          </p>
        </Section>
        <Menu
          itemName="Loco Moco"
        ...
        <Menu itemName="Fries" itemDescription="" price="4" />
        <Menu itemName="Sweet Potato Fries" itemDescription="" price="5" />
        <Menu itemName="Tater Tots" itemDescription="" price="5" />
        <Menu itemName="Loaded Tater Tots" itemDescription="" price="8" />
      </Section>
      <Section style={{ margin: "2rem auto" }}>
        <Intro
      ...
      <Section style={{ margin: "2rem auto" }}>
        <Intro
          heading="DINNER ADDITIONS"
          subheading="No Rice or Mac Salad. Served after 2pm daily"
        />
      </Section>
      <Section id="menu">
        <Menu
